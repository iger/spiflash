...
# Linux example
TEENSYDIR = $(HOME)/arduino-1.8.5/hardware/tools
...
AR = $(TCDIR)/../arm-none-eabi/bin/ar
SIZE = $(TCDIR)/arm-none-eabi-size
OBJCOPY = $(TCDIR)/../arm-none-eabi/bin/objcopy

export OPTIONS CFLAGS CXXFLAGS TCDIR CC CXX AR

DEPS = $(CDEPS) xmodem.h
SOURCES = spiflash.c xmodem.c
